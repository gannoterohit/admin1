...
<div class="page-content">
    <div class="container-fluid">
            ...
            <div class="inv px-3 py-5">
                ...
                <div class="row my-3">
                    <div class="col-6">
                        ...
                        <h5 class="mb-0"><b>Mr. Nitesh Malviya</b></h5>
        ...
        <div class="row mt-2 d-flex justify-content-center align-items-center">
            <div class="col-3">
                <button class="btn btn-dark w-100 print-button">Print Invoice <i class="fa-solid fa-print"></i></button>
            </div>
        </div>
