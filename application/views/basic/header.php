                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="<?= base_url(); ?>" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="assets/images/white-logo-b.png" alt="logo-light" style="width: 160px;">
                                </span>
                            </a>
                        </div>
                      ...
                      <div class="page-title-box align-self-center d-none d-md-block">
                        <h4 class="page-title mb-0 text-capitalize"><?php 
                        $last_segment = $this->uri->segment($this->uri->total_segments());
                        $modifiedString = str_replace("-", " ", $last_segment);
                        echo $modifiedString;
                        ?></h4>
                      </div>
                      <!-- end page title -->
                                ...
                                <div data-simplebar style="max-height: 230px;">
                                    <a href="#" class="text-reset notification-item">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-1">
                                                <h6 class="mb-1">Revenue 50% Increase</h6>
                                    ...
                                    <a href="#" class="text-reset notification-item">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-1">
                                                <h6 class="mb-1">Expense 50% Increase</h6>
                                                <div class="font-size-12 text-muted">
            ...
            <div class="vertical-menu">
                 ...
                 <div class="navbar-brand-box">
                    ...
                    <a href="<?= base_url(); ?>" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                              <!-- <h4 style="color: #fff;margin-top: 14px;text-transform: capitalize;font-weight: 600;">HiSaab</h4>
                            <p style="color: #ffffffde;line-height: 0;">Quantifying Your Success</p> -->
                            <img src="assets/images/white-logo-m.png" alt="logo-light" class="img-fluid" style="width: 186px;">
                        </span>
                    </a>
                </div>
                ...
                <div data-simplebar class="vertical-scroll">
                    ...
                    <div id="sidebar-menu">
                            ...
                            <button type="button" class="btn btn-light w-100 waves-effect waves-light border-0" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-2 text-start">
                                        <h6 class="mb-1 fw-medium user-name-text"> Company Name </h6>
                                        <p class="font-size-13 text-muted user-name-sub-text mb-0">123456789123456 </p>
                                    </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-end w-100">
                                ...
                                <a class="dropdown-item d-flex align-items-center px-3" href="#">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0 dropdown-name">Company 1</h6>
                                        <p class="text-muted font-size-13 mb-0 dropdown-sub-desc">GSTIN: 45457....457</p>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center px-3" href="#">
                                    <div class="flex-shrink-0 me-2">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0 dropdown-name">Company 2</h6>
                                        <p class="text-muted font-size-13 mb-0 dropdown-sub-desc">GSTIN: 74747....001</p>
                                    </div>
                                </a>
                                ...
                                <a class="dropdown-item d-flex align-items-center px-3" href="#">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0 dropdown-name">Company 3</h6>
                                        <h6 class="mb-0 dropdown-name">Company 3</h6>
                                        <p class="text-muted font-size-13 mb-0 dropdown-sub-desc">GSTIN: 74747....001</p>
                                    </div>
                                </a>
                                ...
                                <a class="dropdown-item d-flex align-items-center px-3" href="#">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0 dropdown-name">Company 4</h6>
                                        <p class="text-muted font-size-13 mb-0 dropdown-sub-desc">GSTIN: 74747....001</p>
                                    </div>
                                </a>
                        ...
                        <!-- Left Menu Start -->
                        <?php $this->load->view('basic/menus') ?>
